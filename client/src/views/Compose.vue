      ...
      <b-row class="d-flex flex-column align-items-center">
        <b-col class="article-image" >
          <form enctype="multipart/form-data" @submit.prevent="newArticle">
            ...
            <b-button class="mt-2" type="submit" variant="info" aria-label="Create my article">Create my article !</b-button>
          </form>
        </b-col>
      </b-row>
    </b-container>
...
export default {
  ...
  metaInfo: {
    title: 'Groupomania - Write your article !',
    htmlAttrs: {
        lang: 'en'
      }
  },
